        ...
        <section className='home px-5'>
            <div className="overlay">
                <article className='lg:w-1/2 lg:mr-20'>
                    <h1 className='text-2xl text-gray-400 uppercase'>So, you want to travel to
                ...
                <article className='mt-20'>
                    <button className='w-48 h-48 rounded-full bg-white text-gray-800 uppercase font-bold text-4xl animate-pulse'>
